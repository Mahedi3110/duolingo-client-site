...
const Profile = () => {
    ...
    return (
        <div className='pt-7 pb-20'>
            <div className='h-screen flex justify-center flex-col relative items-center mt-5'>
                <div className='grid grid-cols-2 w-5/12 border-2 pl-5 pr-5 h-80 items-center -mt-11 absolute'>
                    ...
                    <div>
                        ...
                        <button onClick={handleLogOut} className='btn bg-lime-500 rounded-full hover:bg-lime-600 text-white normal-case mt-3 px-12'>Log Out</button>
                    </div>
                </div>
            </div>
        </div>
