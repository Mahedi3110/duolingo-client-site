...
const Login = () => {
    ...
    return (
        <div className="hero min-h-80 pt-32 pb-32">
            <div
                data-aos="fade-up"
                data-aos-easing="linear"
                data-aos-duration="500"
                className="hero-content flex-col lg:flex-row-reverse pt-0 md:w-4/12 w-10/12">
                <div className="card flex-shrink-0 w-full shadow-2xl bg-lime-100">
                    <div className="card-body">
                        <form onSubmit={handleLogin}>
                            ...
                            <div className="form-control mt-6 flex flex-col items-center">
                                ...
                                bg-lime-500 border-0 hover:bg-lime-600
                                normal-case font-bold text-lg rounded-full">Login</button>
                                <p className='ml-2'>Don't have an account? <Link to="/register" className="btn modal-button normal-case text-lime-600 hover:text-lime-700 btn-link p-0 ml-1">Please Register.</Link></p>
                            </div>
                        </form>
                        <div className='mt-0 flex flex-col items-center'>
                            <h1>You can also login with <span onClick={handleGoogleSignIn} className='text-2xl border-0 p-0 ml-1 normal-case font-bold text-lime-500 btn btn-link'>Google</span></h1>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className="modal">
                <div className="modal-box relative max-w-md">
                    <label htmlFor="my-modal-4" className="btn btn-sm bg-lime-500 hover:bg-lime-600 border-0 btn-circle absolute right-2 top-2">✕</label>
                    {
                        clicked ?
                            <div className='flex flex-col items-center'>
                                ...
                                <button onClick={() => setClicked(false)} className='btn text-lg normal-case font-bold bg-lime-500 border-0 hover:bg-lime-600 rounded-full'>Send again</button>
                            </div>
                            :
                            <form onSubmit={recoverPassword} className='flex flex-col mt-5 mb-3'>
                                ...
                                <input type='submit' value='Submit' className='btn rounded-full text-lg mx-5 mt-5 normal-case font-bold bg-lime-500 border-0 hover:bg-lime-600' />
                            </form>
                    }
                </div>
            </div>
